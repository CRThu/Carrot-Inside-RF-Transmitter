...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_13 -L xil_defaultlib -L secureip -L xpm --snapshot srrc_filter_0 xil_defaultlib.srrc_filter_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim srrc_filter_0 -key {Behavioral:sim_1:Functional:srrc_filter_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb srrc_filter_0.wdb xsim.dir)
