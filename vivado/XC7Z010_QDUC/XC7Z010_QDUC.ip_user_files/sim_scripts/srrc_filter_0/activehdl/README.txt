...
#
# Generated by export_simulation on Thu Oct 15 21:33:28 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './srrc_filter_0.sh' script.

./srrc_filter_0.sh -reset_run
...
./srrc_filter_0.sh -noclean_files

For more information on the script, please type './srrc_filter_0.sh -help'.
