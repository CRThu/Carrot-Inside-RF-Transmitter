...
#
# Generated by export_simulation on Wed Oct 14 00:12:52 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './halfband_filter_0.sh' script.

./halfband_filter_0.sh -reset_run
...
./halfband_filter_0.sh -noclean_files

For more information on the script, please type './halfband_filter_0.sh -help'.
