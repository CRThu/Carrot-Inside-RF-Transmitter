...
#
# Generated by export_simulation on Fri Nov 06 17:33:20 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './cic_comp_filter_0.sh' script.

./cic_comp_filter_0.sh -reset_run
...
./cic_comp_filter_0.sh -noclean_files

For more information on the script, please type './cic_comp_filter_0.sh -help'.
