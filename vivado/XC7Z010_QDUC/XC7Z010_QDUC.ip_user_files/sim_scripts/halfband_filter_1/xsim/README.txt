...
#
# Generated by export_simulation on Wed Oct 14 00:19:49 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './halfband_filter_1.sh' script.

./halfband_filter_1.sh -reset_run
...
./halfband_filter_1.sh -noclean_files

For more information on the script, please type './halfband_filter_1.sh -help'.
