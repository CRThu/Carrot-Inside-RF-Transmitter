...
HD_PWD='D:/Projects/RF-Transmitter/vivado/XC7Z010_QDUC/XC7Z010_QDUC.runs/halfband_filter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log halfband_filter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source halfband_filter_0.tcl
